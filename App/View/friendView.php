    ...
    <table id="friend">
        ...
        <?php 
            ...
            <tr>
                ...
                <th><button name="deleteA" > <a href="index.php?page=friend&id=<?= $friendA['id'] ?>" > Supprimer</a></button></th>            
            </tr>
            <?php 
             endforeach;
            ...
            <tr>
                ...
                <th><button name="deleteB" > <a href="index.php?page=friend&id=<?= $friendB['id'] ?>"> Supprimer</a></button></th>            
            </tr>
            <?php 
             endforeach ;?>
        </tbody>
